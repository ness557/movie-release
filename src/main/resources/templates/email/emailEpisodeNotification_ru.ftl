...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="500" style="border-collapse: collapse;">
    <tr>
        ...
        ${releaseDate} Вышел<span> </span>
            <a style="color:#fff;" href="${episodeLink}">${episodeNum} эпизод</a><span> </span>
            <a style="color:#fff;" href="${seasonLink}">${seasonNum} сезона</a><span> </span>
            <a style="color:#fff;" href="${showLink}">${show}</a>
            <br>
        </td>
    </tr>
    <tr>
