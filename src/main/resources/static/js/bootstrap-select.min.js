    ...
    !function (F) {
        ...
        var l = function (t) {
            ...
            m = l({"&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"', "&#x27;": "'", "&#x60;": "`"}), E = {
                ...
                104: "8",
                105: "9"
            }, C = 27, O = 13, T = 32, D = 9, H = 38, L = 40, _ = {success: !1, major: "3"};
        try {
        ...
        "4" === _.major && (q.DIVIDER = "dropdown-divider", q.SHOW = "show", q.BUTTONCLASS = "btn-link", q.POPOVERHEADER = "popover-header");
        ...
        function r(e) {
            ...
            if ([].shift.apply(l), !_.success) {
                ...
                _.major = _.full[0], _.success = !0, "4" === _.major && (q.DIVIDER = "dropdown-divider", q.SHOW = "show", q.BUTTONCLASS = "btn-link", c.DEFAULTS.style = q.BUTTONCLASS = "btn-link", q.POPOVERHEADER = "popover-header")
            }
        ...
        c.VERSION = "1.13.3", c.BootstrapVersion = _.major, c.DEFAULTS = {
            ...
            virtualScroll: 600,
            display: !1
        }, "4" === _.major && (c.DEFAULTS.style = "btn-link", c.DEFAULTS.iconBase = "", c.DEFAULTS.tickIcon = "bs-ok-default"), c.prototype = {
            constructor: c,
            init: function () {
                ...
                j.each(function (e) {
                    ...
                    if (R++, !t.hasClass("bs-title-option")) {
                        var i, s, n = t.data(), o = this.className || "", l = G(this.style.cssText), r = n.content,
                            ...
                            m = "OPTGROUP" === u.tagName, f = m && u.disabled, v = this.disabled || f,
            ...
            liHeight: function (e) {
                if (e || !1 !== this.options.size && !this.sizeInfo) {
                    ...
                    var v, g = c.offsetHeight, b = l ? l.offsetHeight : 0, w = d ? d.offsetHeight : 0,
                        x = h ? h.offsetHeight : 0, I = p ? p.offsetHeight : 0, k = u ? u.offsetHeight : 0,
                        $ = F(o).outerHeight(!0), E = !!window.getComputedStyle && window.getComputedStyle(i),
                        S = i.offsetWidth, y = E ? null : F(i), C = {
            ...
            setMenuSize: function (e) {
                ...
                var t, i, s, n, o, l, r, c = this.sizeInfo.selectWidth, a = this.sizeInfo.liHeight,
                    ...
                    u = this.sizeInfo.doneButtonHeight, m = this.sizeInfo.dividerHeight, f = this.sizeInfo.menuPadding,
                    v = 0;
                    ...
                    if (E.multiple && 1 !== E.options.maxOptions && e.stopPropagation(), e.preventDefault(), !E.isDisabled() && !i.parent().hasClass(q.DISABLED)) {
                        ...
                        if (n === E.activeIndex && (t = !0), t || (E.prevActiveIndex = E.activeIndex, E.activeIndex = void 0), E.multiple) {
                            if (a.prop("selected", !d), E.setSelected(n, !d), i.blur(), !1 !== u || !1 !== m) {
                                var f = u < c.filter(":selected").length, v = m < h.find("option:selected").length;
                                if (u && f || m && v) if (u && 1 == u) {
                                    ...
                                    var w = "string" == typeof E.options.maxOptionsText ? [E.options.maxOptionsText, E.options.maxOptionsText] : E.options.maxOptionsText,
                                        x = "function" == typeof w ? w(u, m) : w, I = x[0].replace("{n}", u),
                                        k = x[1].replace("{n}", m), $ = F('<div class="notify"></div>');
            ...
            liveSearchListener: function () {
                var u = this, m = document.createElement("li");
                this.$button.on("click.bs.dropdown.data-api", function () {
            ...
            keydown: function (e) {
                var t, i, s, n, o, l = F(this), r = l.hasClass("dropdown-toggle"),
                    ...
                    u = c.$menuInner[0].scrollTop, m = c.isVirtual(), f = !0 === m ? c.selectpicker.view.position0 : 0;
